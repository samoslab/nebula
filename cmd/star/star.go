...
import (
	...
	"github.com/suncoin/src/util/browser"
	"github.com/suncoin/src/util/file"
)

const (
	defaultConfigSubDir    = ".spacocosmos"
...
type Config struct {
	...
	CXORPC     bool `json:"cxo_rpc"`                // Whether to enable CXO RPC.(for admin)
