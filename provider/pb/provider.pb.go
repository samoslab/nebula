...
type CheckAvailableReq struct {
	...
	Auth       []byte `protobuf:"bytes,2,opt,name=auth,proto3" json:"auth,omitempty"`
	Timestamp  uint64 `protobuf:"varint,3,opt,name=timestamp" json:"timestamp,omitempty"`
	NodeIdHash []byte `protobuf:"bytes,4,opt,name=nodeIdHash,proto3" json:"nodeIdHash,omitempty"`
}
...
func (m *CheckAvailableReq) GetNodeIdHash() []byte {
	if m != nil {
		return m.NodeIdHash
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
