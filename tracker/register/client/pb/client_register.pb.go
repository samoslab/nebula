...
type PackageDiscountReq struct {
	Version   uint32 `protobuf:"varint,1,opt,name=version" json:"version,omitempty"`
	PackageId int64  `protobuf:"zigzag64,2,opt,name=packageId" json:"packageId,omitempty"`
}

func (m *PackageDiscountReq) Reset()                    { *m = PackageDiscountReq{} }
func (m *PackageDiscountReq) String() string            { return proto.CompactTextString(m) }
func (*PackageDiscountReq) ProtoMessage()               {}
func (*PackageDiscountReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }

func (m *PackageDiscountReq) GetVersion() uint32 {
	if m != nil {
		return m.Version
	}
	return 0
...
func (m *PackageDiscountReq) GetPackageId() int64 {
	if m != nil {
		return m.PackageId
	}
	return 0
...
type PackageDiscountResp struct {
	Discount map[uint32]string `protobuf:"bytes,1,rep,name=discount" json:"discount,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}

func (m *PackageDiscountResp) Reset()                    { *m = PackageDiscountResp{} }
func (m *PackageDiscountResp) String() string            { return proto.CompactTextString(m) }
func (*PackageDiscountResp) ProtoMessage()               {}
func (*PackageDiscountResp) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{17} }

func (m *PackageDiscountResp) GetDiscount() map[uint32]string {
	if m != nil {
		return m.Discount
	}
	return nil
...
func (*BuyPackageReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{18} }
...
func (*BuyPackageResp) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{20} }
...
func (*MyAllOrderReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{21} }
...
func (*MyAllOrderResp) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{22} }
...
func (*OrderInfoReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{23} }
...
func (*OrderInfoResp) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{24} }
...
func (m *RemoveOrderReq) Reset()                    { *m = RemoveOrderReq{} }
func (m *RemoveOrderReq) String() string            { return proto.CompactTextString(m) }
func (*RemoveOrderReq) ProtoMessage()               {}
func (*RemoveOrderReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }

func (m *RemoveOrderReq) GetVersion() uint32 {
	if m != nil {
		return m.Version
	}
	return 0
...
func (m *RemoveOrderReq) GetNodeId() []byte {
	if m != nil {
		return m.NodeId
	}
	return nil
...
func (m *RemoveOrderReq) GetTimestamp() uint64 {
	if m != nil {
		return m.Timestamp
	}
	return 0
...
func (m *RemoveOrderReq) GetOrderId() []byte {
	if m != nil {
		return m.OrderId
	}
	return nil
...
func (m *RemoveOrderReq) GetSign() []byte {
	if m != nil {
		return m.Sign
	}
	return nil
...
type RemoveOrderResp struct {
	Code   uint32 `protobuf:"varint,1,opt,name=code" json:"code,omitempty"`
	ErrMsg string `protobuf:"bytes,2,opt,name=errMsg" json:"errMsg,omitempty"`
}

func (m *RemoveOrderResp) Reset()                    { *m = RemoveOrderResp{} }
func (m *RemoveOrderResp) String() string            { return proto.CompactTextString(m) }
func (*RemoveOrderResp) ProtoMessage()               {}
func (*RemoveOrderResp) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }

func (m *RemoveOrderResp) GetCode() uint32 {
	if m != nil {
		return m.Code
	}
	return 0
...
func (m *RemoveOrderResp) GetErrMsg() string {
	if m != nil {
		return m.ErrMsg
	}
	return ""
...
func (*RechargeAddressReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{27} }
...
type RechargeAddressResp struct {
	Code               uint32 `protobuf:"varint,1,opt,name=code" json:"code,omitempty"`
	ErrMsg             string `protobuf:"bytes,2,opt,name=errMsg" json:"errMsg,omitempty"`
	RechargeAddressEnc []byte `protobuf:"bytes,3,opt,name=rechargeAddressEnc,proto3" json:"rechargeAddressEnc,omitempty"`
...
func (*RechargeAddressResp) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{28} }
...
func (m *RechargeAddressResp) GetRechargeAddressEnc() []byte {
	if m != nil {
		return m.RechargeAddressEnc
	}
	return nil
}
...
func (*PayOrderReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{29} }
...
func (*PayOrderResp) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }
...
func (*UsageAmountReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{31} }
...
func (*UsageAmountResp) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{32} }
...
func init() {
	...
	proto.RegisterType((*PackageDiscountReq)(nil), "register.client.pb.PackageDiscountReq")
	proto.RegisterType((*PackageDiscountResp)(nil), "register.client.pb.PackageDiscountResp")
	...
	proto.RegisterType((*RemoveOrderReq)(nil), "register.client.pb.RemoveOrderReq")
	proto.RegisterType((*RemoveOrderResp)(nil), "register.client.pb.RemoveOrderResp")
...
type OrderServiceClient interface {
	...
	PackageDiscount(ctx context.Context, in *PackageDiscountReq, opts ...grpc.CallOption) (*PackageDiscountResp, error)
	...
	RemoveOrder(ctx context.Context, in *RemoveOrderReq, opts ...grpc.CallOption) (*RemoveOrderResp, error)
...
func (c *orderServiceClient) PackageDiscount(ctx context.Context, in *PackageDiscountReq, opts ...grpc.CallOption) (*PackageDiscountResp, error) {
	out := new(PackageDiscountResp)
	err := grpc.Invoke(ctx, "/register.client.pb.OrderService/PackageDiscount", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderServiceClient) RemoveOrder(ctx context.Context, in *RemoveOrderReq, opts ...grpc.CallOption) (*RemoveOrderResp, error) {
	out := new(RemoveOrderResp)
	err := grpc.Invoke(ctx, "/register.client.pb.OrderService/RemoveOrder", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	...
	PackageDiscount(context.Context, *PackageDiscountReq) (*PackageDiscountResp, error)
	...
	RemoveOrder(context.Context, *RemoveOrderReq) (*RemoveOrderResp, error)
...
func _OrderService_PackageDiscount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PackageDiscountReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).PackageDiscount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/register.client.pb.OrderService/PackageDiscount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).PackageDiscount(ctx, req.(*PackageDiscountReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OrderService_RemoveOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/register.client.pb.OrderService/RemoveOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).RemoveOrder(ctx, req.(*RemoveOrderReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _OrderService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PackageDiscount",
			Handler:    _OrderService_PackageDiscount_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
